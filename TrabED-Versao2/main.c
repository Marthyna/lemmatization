...
int main(int argc, char *argv[])
{
    ...
    nodo *ABP = NULL;       //estrutura para armazenar dicionario
        ...
        else
        {
            ...
            while (fgets(linha,CHARMAX,dicionario))     //enquanto há linhas pra ler
            {
                ...
                while (palavra != NULL)                 //enquanto não chegou no fim da linha
                {
                    ...
                    lema = strlwr(lema);
                    ABP = InsereABP(ABP,palavra,lema);  //insere o nodo com palavra e lema na ABP
            ...
            else
            {
                ...
                while (fgets(linha,CHARMAX,entrada))
                {
                    ...
                    {
                        lema = pegaLema(ABP,palavra);    //procura o lema correspondente na árvore
